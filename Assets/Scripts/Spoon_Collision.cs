...
public class Spoon_Collision : MonoBehaviour
{
    //本腳本放在湯匙上
    ...
    void Update()
    {
        ...
        if (Hint_Manager.Currentstep == 5 && SpoonTimes == 6 && !isgotoLitmusPaper)
        {
        ...
        if (a <= -0.03f && Hint_Manager.Currentstep != 7)
        {
    ...
    public void OnTriggerEnter(Collider other)
    {
        ...
        if(other.CompareTag("Dishes"))  //白固體湯匙到蒸發皿
        {
            if(is_scoop_up)
            {
                ...
                //Dishes這邊做個水上升的動畫效果
                if (SpoonTimes == 1 && Hint_Manager.Currentstep == 4)
                {
                    is_scoop_up = false;
                    color.a = 0.1f;
                    DishesOBJ.GetComponent<Transform>().localScale = new Vector3(3.4f, 2.1f, 6.18f);
                    DishesOBJ_M.color = color;
                }
                else if (SpoonTimes == 2 && Hint_Manager.Currentstep == 4)
                {
                    is_scoop_up = false;
                    color.a = 0.2f;
                ...
                else if (SpoonTimes == 3 && Hint_Manager.Currentstep == 4)
                {
                    is_scoop_up = false;
                    color.a = 0.3f;
                ...
                else if (SpoonTimes == 4 && Hint_Manager.Currentstep == 4)
                {
                    is_scoop_up = false;
                    color.a = 0.4f;
                ...
                else if (SpoonTimes == 5 && Hint_Manager.Currentstep == 4)
                {
                    is_scoop_up = false;
                    color.a = 0.5f;
                ...
                else if (SpoonTimes == 6 && Hint_Manager.Currentstep == 4)
                {
                    is_scoop_up = false;
                    color.a = 0.6f;
            ...
            if (Hint_Manager.Currentstep == 7)   //蒸發皿to 湯匙 to 試管
            {
                is_scoop_up = true;
                SpoonBowlthing.SetActive(true);
                SpoonTimes++;
        ...
        if (other.CompareTag("LitmusPaper"))
        {
            ...
            Debug.Log("現在步驟是：" + Hint_Manager.Currentstep);
            isTouchingLitmusPaper = true;
            BowlthingOnLP.SetActive(true);
        }
        if (other.CompareTag("TestTube") && Hint_Manager.Currentstep == 7)
        {
