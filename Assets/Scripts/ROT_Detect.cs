...
public class ROT_Detect : MonoBehaviour
{
    ...
    public float resetDelay = 600f;
    // Start is called before the first frame update
    void Start()
    {
        logStatus["rot_CoconutOil"] = false;
        logStatus["rot_Alcohol"] = false;
        logStatus["rot_NaOH"] = false;
        logStatus["rot_NaCl"] = false;
        logStatus["rot_H2O"] = false;
        logStatus["rot_SaladOil"] = false;
    }
