...
public class CG_PourToBeaker : MonoBehaviour
{
    //本腳本放在固定燒杯身上。
    ...
    public void OnTriggerStay(Collider other)   //判斷溶液的倒入動畫
    {
        if (other.CompareTag("CoconutOil"))
        {
            if (CG_ROT_Detect.rot_CoconutOil >= 60 && CG_ROT_Detect.rot_CoconutOil <= 110 || CG_ROT_Detect.rot_CoconutOil >= 270 && CG_ROT_Detect.rot_CoconutOil <= 320)
            {
                ...
                if (CG_ROT_Detect.rot_CoconutOil >= 270 && CG_ROT_Detect.rot_CoconutOil <= 320)
                {
                    CoconutOilParticle1.Play();
                    CoconutOilPGM1.transform.localRotation = Quaternion.Euler(-CoconutOil_rotationX1 - 90.0f, 0, 0);
                }
                if (CG_ROT_Detect.rot_CoconutOil >= 60 && CG_ROT_Detect.rot_CoconutOil <= 110)
                {
        ...
        if (other.CompareTag("Alcohol"))
        {
            if (CG_ROT_Detect.rot_Alcohol >= 60 && CG_ROT_Detect.rot_Alcohol <= 110 || CG_ROT_Detect.rot_Alcohol >= 270 && CG_ROT_Detect.rot_Alcohol <= 320)
            {
                ...
                if (CG_ROT_Detect.rot_Alcohol >= 270 && CG_ROT_Detect.rot_Alcohol <= 320)
                {
                    AlcoholParticle1.Play();
                    AlcoholPGM1.transform.localRotation = Quaternion.Euler(-Alcohol_rotationX1 - 90.0f, 0, 0);
                }
                if (CG_ROT_Detect.rot_Alcohol >= 60 && CG_ROT_Detect.rot_Alcohol <= 110)
                {
        ...
        if (other.CompareTag("NaOH"))
        {
            if (CG_ROT_Detect.rot_NaOH >= 60 && CG_ROT_Detect.rot_NaOH <= 110 || CG_ROT_Detect.rot_NaOH >= 270 && CG_ROT_Detect.rot_NaOH <= 320)
            {
                NaOH_isPoured = true;
                ...
                if (CG_ROT_Detect.rot_NaOH >= 270 && CG_ROT_Detect.rot_NaOH <= 320)
                {
                    NaOHPGM1.transform.localRotation = Quaternion.Euler(-NaOH_rotationX1 - 90.0f, 0, 0);
                    NaOHParticle1.Play();
                }
                if (CG_ROT_Detect.rot_NaOH >= 60 && CG_ROT_Detect.rot_NaOH <= 110)
                {
        ...
        if (other.CompareTag("NaCl"))
        {
            if (CG_ROT_Detect.rot_NaCl >= 60 && CG_ROT_Detect.rot_NaCl <= 110 || CG_ROT_Detect.rot_NaCl >= 270 && CG_ROT_Detect.rot_NaCl <= 320)
            {
                NaCl_isPoured = true;
                ...
                if (CG_ROT_Detect.rot_NaCl >= 270 && CG_ROT_Detect.rot_NaCl <= 320)
                {
                    NaClPGM1.transform.localRotation = Quaternion.Euler(-NaCl_rotationX1 - 90.0f, 0, 0);
                    NaClParticle1.Play();
                }
                if (CG_ROT_Detect.rot_NaCl >= 60 && CG_ROT_Detect.rot_NaCl <= 110)
                {
    ...
    public void Update()        //還要再多一個判定才能確定是不是要顯示圖片?
    {
        ...
        CoconutOil_rotationX1 = Mathf.Lerp(185f, 135f, Mathf.InverseLerp(270f, 320f, CG_ROT_Detect.rot_CoconutOil));
        CoconutOil_rotationX2 = Mathf.Lerp(40f, -10f, Mathf.InverseLerp(60f, 110f, CG_ROT_Detect.rot_CoconutOil));
        Alcohol_rotationX1 = Mathf.Lerp(185f, 135f, Mathf.InverseLerp(270f, 320f, CG_ROT_Detect.rot_Alcohol));
        Alcohol_rotationX2 = Mathf.Lerp(40f, -10f, Mathf.InverseLerp(60f, 110f, CG_ROT_Detect.rot_Alcohol));
        NaOH_rotationX1 = Mathf.Lerp(185f, 135f, Mathf.InverseLerp(270f, 320f, CG_ROT_Detect.rot_NaOH));
        NaOH_rotationX2 = Mathf.Lerp(40f, -10f, Mathf.InverseLerp(60f, 110f, CG_ROT_Detect.rot_NaOH));
        NaCl_rotationX1 = Mathf.Lerp(185f, 135f, Mathf.InverseLerp(270f, 320f, CG_ROT_Detect.rot_NaCl));
        NaCl_rotationX2 = Mathf.Lerp(40f, -10f, Mathf.InverseLerp(60f, 110f, CG_ROT_Detect.rot_NaCl));
